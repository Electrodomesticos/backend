...
users = User.create([{ user_name: 'user1', email: 'user1@test.com', first_name: 'User1', last_name: 'U1', telephone: '333333', address: 'cll 3 # 4', city: 'City1' },
                     { user_name: 'user3', email: 'user3@test.com', first_name: 'User3', last_name: 'U3', telephone: '111111', address: 'kr 12 # 5', city: 'City2' },
